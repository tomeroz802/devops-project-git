...
#  By adding raise KeyError("No ...") after the loop, other way of use a "simple return"
#  we explicitly raise a KeyError when no state is found for the given capital.
#  The Simple return that have been replaced in next line:
